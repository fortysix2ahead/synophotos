...
no_login_commands = [ 'init', 'logout', 'profile', 'profiles', 'version' ]
...
@option( '-s', '--size', required=False, default='original', help='download image in specified size, can be one of [sm, m, xl, compressed, original]' )
